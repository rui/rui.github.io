...
![img](/images/document/config.png)
...
![img](/images/document/Typora.png)
...
![img](/images/document/Disqus-plan.png)

注册成功后，新建一个站点（site），以LOFFER为例设置步骤如下：

首先站点名LOFFER，生成了shortname是loffer，类型可以随便选。

![img](/images/document/Disqus-1.png)

安装时选择Jekyll。

![img](/images/document/Disqus-2.png)

最后填入你的博客地址，语言可以选中文，点Complete，即可！

![img](/images/document/Disqus-3.png)
...
![img](/images/document/application_settings.png)
...
![img](/images/document/givemefive.png)
